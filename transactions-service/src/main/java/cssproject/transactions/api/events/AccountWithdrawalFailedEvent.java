...
public class AccountWithdrawalFailedEvent extends TransactionEvent {

    public AccountWithdrawalFailedEvent(EventType type, Map payload, String aggregate, UUID command_id, TransactionDAO transactionDAO){
