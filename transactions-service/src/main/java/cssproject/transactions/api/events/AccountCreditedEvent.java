...
public class AccountCreditedEvent extends TransactionEvent {

    public AccountCreditedEvent(EventType type, Map payload, String aggregate, UUID command_id, TransactionDAO transactionDAO){
