...
public class AccountDepositFailedEvent extends TransactionEvent {

    public AccountDepositFailedEvent(EventType type, Map payload, String aggregate, UUID command_id, TransactionDAO transactionDAO){
