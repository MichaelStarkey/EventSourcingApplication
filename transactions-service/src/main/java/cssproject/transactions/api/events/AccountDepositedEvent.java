...
public class AccountDepositedEvent extends TransactionEvent {

    public AccountDepositedEvent(EventType type, Map payload, String aggregate, UUID command_id, TransactionDAO transactionDAO){
