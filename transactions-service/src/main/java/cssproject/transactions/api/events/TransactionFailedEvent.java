...
public class TransactionFailedEvent extends TransactionEvent{
    ...
    public TransactionFailedEvent(AbstractEvent.EventType type, Map payload, String aggregate, UUID command_id, TransactionDAO transactionDAO){
    ...
    public void apply() {
        ...
        t.setStatus(AbstractEvent.EventType.FAILED.name());
