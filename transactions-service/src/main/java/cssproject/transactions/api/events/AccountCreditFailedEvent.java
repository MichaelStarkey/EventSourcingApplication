...
public class AccountCreditFailedEvent extends TransactionEvent {

    public AccountCreditFailedEvent(EventType type, Map payload, String aggregate, UUID command_id, TransactionDAO transactionDAO){
